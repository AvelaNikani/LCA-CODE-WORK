...
number = int(input("What number do you want square?: "))
...
print(f"{number} multiplied by {number} is equalled to {answer}.")
...
length = int(input("What would the length of the rectangle be?: "))
...
print(f"The area of the rectangle is {area} metres squared")
